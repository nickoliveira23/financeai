...
export const generateAiReport = async ({ month }: GenerateAiReportSchema) => {
  ...
  const content = `Gere um relatório com insights sobre as minhas finanças, com dias e orientações de como melhorar minha vida financeira. As transações estão divididas por ponto e vírgula. A estrutura de cada uma e é {DATA}-{TIPO}-{VALOR}-{CATEGORIA}. São elas:
  ${transactions
    .map(
      (transaction) =>
    ...
    messages: [
      {
        role: "system",
        content:
          "Você é um especialista em gestão e organização de finanaças pessoais. Você ajuda as pessoas a organizarem melhor as suas finanças",
      },
      {
        role: "user",
        content,
